...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ProductionDevs/next-netlify&utm_source=github&utm_medium=nextstarter-cs&utm_campaign=devex)
...
2. Clone this repo: `git clone https://github.com/cassidoo/next-netlify-starter.git`
3. Navigate to the directory and run `npm run dev`
4. Make your changes
